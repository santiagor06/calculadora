...
sum.grid(row=1,column=0,padx=1,pady=1)
...
potencia.grid(row=2,column=2,padx=1,pady=1)
...
dot.grid(row=2,column=3,padx=1,pady=1)
...
total=Button(window,text="=",width=40,height=2,command=lambda:calcTotal(),background="#008000")
